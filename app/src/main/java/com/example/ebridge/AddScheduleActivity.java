...
public class AddScheduleActivity extends CommonAuth {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(AddScheduleActivity.this);
    ...
    public void addJob(){
        ...
        if(!err){
            Job job = new Job(sposition,sexperienceRequired,sdepartment,spositionAvailable);
                ...
                Toast.makeText(AddScheduleActivity.this, "Job Added Successfully.", Toast.LENGTH_LONG).show();

                startActivity(new Intent(AddScheduleActivity.this, AdminJobsActivity.class));
