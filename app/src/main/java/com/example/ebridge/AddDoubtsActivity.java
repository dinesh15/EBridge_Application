...
public class AddDoubtsActivity extends CommonAuth {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPostButton = findViewById(R.id.addDoubtButton);
        ...
        navBars(AddDoubtsActivity.this);
    ...
    public void addPost(){
        ...
        if(!err){
            Post post = new Post(postTitleS,postDetailsS);
                ...
                Toast.makeText(AddDoubtsActivity.this, "Post Added Successfully.", Toast.LENGTH_LONG).show();

                startActivity(new Intent(AddDoubtsActivity.this, FacultyPostsActivity.class));
