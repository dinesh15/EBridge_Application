...
public class StudentEventsActivity extends CommonAuth {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(StudentEventsActivity.this);
        ...
        db.child("events").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(StudentEventsActivity.this));
