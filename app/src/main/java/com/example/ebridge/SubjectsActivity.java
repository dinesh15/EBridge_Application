...
public class SubjectsActivity extends CommonAuth {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getItemId() == R.id.nav_home){
                    Intent l = new Intent(SubjectsActivity.this, MainActivity.class);
                    startActivity(l);
                }else  if(item.getItemId() == R.id.nav_feedback){
                    Intent l = new Intent(SubjectsActivity.this, FeedbackActivity.class);
                    startActivity(l);
                }else  if(item.getItemId() == R.id.nav_profile){
                    Intent l = new Intent(SubjectsActivity.this, ProfileActivity.class);
                    startActivity(l);
                }
                else  if(item.getItemId() == R.id.nav_add_subject){
                    Intent l = new Intent(SubjectsActivity.this, AddSubjectActivity.class);
                    startActivity(l);
                }else  if(item.getItemId() == R.id.nav_Subjects){
                    Intent l = new Intent(SubjectsActivity.this, SubjectsActivity.class);
                    startActivity(l);
