...
public class AddResourceActivity extends CommonAuth {
    ...
    public void addJob(){
        ...
        if(!err){
            Job job = new Job(sposition,sexperienceRequired,sdepartment,spositionAvailable);
                ...
                Toast.makeText(AddResourceActivity.this, "Job Added Successfully.", Toast.LENGTH_LONG).show();

                startActivity(new Intent(AddResourceActivity.this, AdminJobsActivity.class));
