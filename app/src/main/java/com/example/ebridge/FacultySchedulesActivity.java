...
public class FacultySchedulesActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_schedules);
        ...
        navBars(FacultySchedulesActivity.this);
        ...
        db.child("subjects").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(FacultySchedulesActivity.this));
