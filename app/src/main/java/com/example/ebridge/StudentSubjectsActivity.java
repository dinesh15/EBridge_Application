...
public class StudentSubjectsActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(StudentSubjectsActivity.this);
        ...
        db.child("users").child(loggedUser.getUsername()).child("subjects").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(StudentSubjectsActivity.this));
