...
public class StudentSchedulesActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(StudentSchedulesActivity.this);

        db = FirebaseDatabase.getInstance().getReference().child("E-Bridge");
        db.child("schedules").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecyclerView recyclerView = findViewById(R.id.schedulesListView);
                recyclerView.setLayoutManager(new LinearLayoutManager(StudentSchedulesActivity.this));
