...
public class FacultyProfileActivity extends CommonAuth {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(FacultyProfileActivity.this);

        roleView.setText("Role: Faculty");
    ...
    private void Register() {
        ...
        if (!err) {
                ...
                Toast.makeText(FacultyProfileActivity.this, "Account Updated Successfully.", Toast.LENGTH_LONG).show();
                startActivity(new Intent(FacultyProfileActivity.this, FacultyHomeActivity.class));
