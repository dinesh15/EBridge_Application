...
public class FacultyEventsActivity extends CommonAuth {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(FacultyEventsActivity.this);
        ...
        db.child("events").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(FacultyEventsActivity.this));
