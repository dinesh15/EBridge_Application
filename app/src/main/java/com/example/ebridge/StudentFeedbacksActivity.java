...
public class StudentFeedbacksActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(StudentFeedbacksActivity.this);
        ...
        db.child("feedbacks").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(StudentFeedbacksActivity.this));
