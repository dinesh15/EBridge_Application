...
public class FacultyJobsActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_jobs);
        ...
        navBars(FacultyJobsActivity.this);
        ...
        db.child("jobs").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(FacultyJobsActivity.this));
