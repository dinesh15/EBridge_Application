...
public class StudentAttendancesActivity extends CommonAuth {
...
//    private Button btnLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navBars(StudentAttendancesActivity.this);

        db = FirebaseDatabase.getInstance().getReference().child("E-Bridge");
        db.child("attendances").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecyclerView recyclerView = findViewById(R.id.attendancesListView);
                recyclerView.setLayoutManager(new LinearLayoutManager(StudentAttendancesActivity.this));
